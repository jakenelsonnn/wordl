...
public class SixLetterGraphActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.six_letter_activity_graph);
        int totalGamesPlayed = 0;

        //set up the stats file, build array from file contents, total up the numbers in the file.
        String statsFilePath = getApplicationContext().getFilesDir() + "/" + "six-letter-stats.txt";
        ...
        totalTextView = findViewById(R.id.totalgamesplayed2);
        totalTextView.setText(Integer.toString(totalGamesPlayed));

        //display high score
        highScoreTextView = findViewById(R.id.highscore2);
